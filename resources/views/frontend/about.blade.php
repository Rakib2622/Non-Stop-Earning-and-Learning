         ...
         <div class="row">
             ...
             <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                 ...
                 <ul class="addressFooter">
                    <li><i class="icon anm anm-map-marker-al"></i><p>Bonani Dhaka- Rode-12</p></li>
                    <li class="phone"><i class="icon anm anm-phone-s"></i><p>+8809638329402</p></li>
                    <li class="email"><i class="icon anm anm-envelope-l"></i><p>nonstopearning738@gmail.com</p></li>
                 </ul>
                 <hr />
